...
- Best Seats: Sit at the sides or front of the boat for the clearest views and photo angles.`,
  ...
  },
  {
    ...
    longDescription: "Sheldrick Wildlife Trust (SWT) is a leader in African wildlife conservation. Through its Orphans' Project, SWT has raised over 320 orphaned elephants and rhinos. When grown, each orphan is reintegrated.",
  ...
  },
  {
    ...
    longDescription: "Wildlife sanctuary adjacent to urban skyline with sightings of rhinos, lions, and giraffes. Hosts a rhinoceros conservation program and provides a condensed safari experience.",
  ...
  },
  {
    ...
    longDescription: "Engage with Rothschild giraffes on an elevated walkway, feeding and learning about their conservation in a serene setting near Giraffe Manor.",
    images: ["https://placehold.co/800x600.png"],
  ...
  },
  {
    ...
    longDescription: "Pristine white sandy beach fringed with palm trees, featuring warm waters and diverse sea life. Enjoy camel rides, snorkeling, and local crafts amidst a vibrant coastal scene.",
  ...
  },
  {
    ...
    longDescription: "Sun-kissed beach presenting a fusion of natural beauty, tranquil stretches for romantic walks, and vibrant nightlife to the rhythm of African beats. Features water sports and enchanting sunsets.",
  ...
  },
  {
    ...
    longDescription: "Tranquil forest with diverse trails for cycling, walking, and birdwatching, featuring caves, waterfalls, and scenic spots amidst a biodiverse landscape.",
  ...
  },
  {
    ...
    longDescription: "National park with biking, hiking, rock climbing, and thermal spas amidst stunning geological wonders and diverse wildlife. Enjoy a day of natural exploration and relaxation.",
  ...
  },
  {
    ...
    longDescription: "Historic farmhouse nestled in Ngong Hills, offering guided tours that delve into the life of a famed literary figure, set amid European-style gardens with panoramic views.",
  ...
  },
  {
    ...
    longDescription: "Mount Kenya presents a challenging trek through diverse terrains and rich wildlife, culminating in panoramic summit views. The Sirimon route delights with ascending vistas and scenic descents.",
  ...
  },
  {
    ...
    longDescription: "Tranquil wildlife sanctuary within the Great Rift Valley, featuring diverse species like rhinos and flamingos amid serene landscapes and birdwatching havens.",
    images: ["https://placehold.co/800x600.png"],
  ...
  },
  {
    ...
    longDescription: "High-end shopping destination in the diplomatic district with a mix of local and African brands, family-friendly activities, and a relaxed vibe. Hosts the Masai Market weekly.",
  ...
  },
  {
    ...
    longDescription: "Geological wonder with vibrant sandstone cliffs and gorges, renowned for its stunning sunset views. Local legends and hiking routes enrich the visitor's journey.",
  ...
  },
  {
    ...
    longDescription: "Interactive wildlife encounters in a natural setting with trails, featuring giraffe feeding, a crocodile section, and educational tours.",
  ...
  },
  {
    ...
    longDescription: "Pristine sandy beach in a lively neighborhood, ideal for swimming and snorkeling in the Indian Ocean. Enjoy local vendors and the picturesque sunset on a boat tour.",
  ...
  },
  {
    ...
    longDescription: "Wildlife conservancy with a focus on rhino conservation, providing game drives, lion tracking, and rare animal encounters. Features a chimp sanctuary and bush walks.",
  ...
  },
  {
    ...
    longDescription: "Fort Jesus is Mombasa’s most popular tourist attraction. The fort, located along the coastline near the Old Town, is a monumental piece of architecture that was built in the 16th century by the Portuguese.",
  ...
  },
  {
    ...
    longDescription: "Tropical marine sanctuary with pristine beaches and clear waters for snorkeling. Enjoy diverse aquatic life, from colorful fish to playful dolphins, and participate in turtle releases.",
  ...
  },
  {
    ...
    longDescription: "The Watamu Marine National Park and Reserve was established in 1968, making it, together with the Malindi Marine National Park, one of the oldest marine parks in Africa. In 1979",
  ...
  },
  {
    ...
    longDescription: "Coffee estate tour through a lush farm, with insights into coffee production from plant to cup, complete with tastings and picturesque garden views.",
  ...
  },
  {
    ...
    longDescription: "Scenic hillside destination for hiking, ziplining, and picnics, with panoramic views of the Rift Valley and unique windmill landscape. Ideal for day trips and outdoor adventures.",
  ...
  },
  {
    ...
    longDescription: "Scenic wildlife sanctuary with action-packed landscapes, tranquil boat rides, and diverse birdlife. Ideal for nature enthusiasts and adventure seekers. Advance booking recommended.",
  ...
  },
  {
    ...
    longDescription: "Karen Blixen Coffee Garden & Cottages is set in what used to be Karen Blixen’s old coffee farm estate, in the heart of Karen in beautiful gardens and a peaceful suburb approximately 20 miles from.",
  ...
  },
  {
    ...
    longDescription: "Shopping destination providing a variety of retail outlets, a food court, and an art caffe, set within a bustling mall atmosphere. Includes a centralized customer support center.",
  ...
  },
  {
    ...
    longDescription: "Safari experience with close wildlife encounters, including large elephant herds and diverse birdlife, set against the backdrop of Mount Kilimanjaro. Observation Hill provides panoramic views.",
  ...
  },
  {
    ...
    longDescription: "Challenging hike through Great Rift Valley rewards with panoramic vistas of the crater and diverse flora and fauna. Ideal for nature and outdoor activity enthusiasts.",
  ...
  },
  {
    ...
    longDescription: "Come and enjoy a lunch time tour of the farm with Fiona... Arrive at 11am and over a cup of tea or coffee the history of the farm and process of making tea is informally explained.",
    images: ["https://placehold.co/800x600.png"],
